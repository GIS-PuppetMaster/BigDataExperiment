            ...
            if self.save_best_only:
                ...
                if current is None:
                    ...
                    if self.monitor_op(current, self.best):
                        ...
                        with open('checkPoint_LRB.json', 'wb') as f:
...
opt = None
if not os.path.exists('./checkPointB.h5'):
...
early_stop = keras.callbacks.EarlyStopping(monitor='val_loss', patience=400, restore_best_weights=True)
check_point = CheckPoint_Save_LR(filepath='./checkPointB.h5', monitor='val_loss', optimizer=opt, save_best_only=True,
                                 verbose=1)
